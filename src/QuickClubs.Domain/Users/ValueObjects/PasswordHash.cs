...
public sealed record PasswordHash(string Value)
{
    ...
    public const string PasswordRegex = ""; // TODO: Create an actual regex that represents strong password requirements and add test in Application.UnitTests.Authentication.RegisterCommandValidatorTests
